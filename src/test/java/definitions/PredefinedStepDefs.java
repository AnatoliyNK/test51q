...
public class PredefinedStepDefs {
    ...
    public void iWaitForElementWithXpathToNotBePresent(String xpath) {
        new WebDriverWait(getDriver(), Duration.ofSeconds(10), Duration.ofMillis(200)).until(ExpectedConditions.not(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath))));
    }
